<template>
	<div id="about-section" v-show="show === id" :class="{ fadeIn: show === id }">
		...
		/>
		<p>
			Hello! My name is Carlos, and I'm an entrepreneur, developer and digital
			nomad originally from Buenos Aires, Argentina. I've lived and worked in
        ...
        <br /> -->
		<p>
			I have many interests, such as spending quality time with loved ones,
			travel and international cultures, learning about topics such as
			psychology, health, technology and productivity, watching the Los Angeles
			Lakers, and playing football and beautifully made videogames like Zelda,
			Metroid, and Starcraft.
		</p>
	</div>
</template>
